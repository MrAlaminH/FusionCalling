...
const description =
  "Fusion Calling privacy policy covering data collection, usage, retention, security, and your rights. We never sell your data.";
    ...
    >
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 text-gray-300">
            This policy references the following authoritative regulations and
            standards:
          </p>
          <ul className="list-disc pl-6 space-y-2 text-gray-300">
            ...
            <li>
              ...
              — which governs our use of Google Calendar data.
            </li>
          </ul>
          </section>
        </div>
