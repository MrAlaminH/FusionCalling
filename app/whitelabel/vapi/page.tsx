  ...
  return (
    <>
      ...
      <main id="main" className="min-h-screen w-full bg-black">
        ...
        <section id="vapi-differentiators" className="w-full bg-black section-spacing">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="block text-sm text-gray-400 mt-1">
                  Cost-effective calls or premium voices.
                </span>
              </Link>
              <Link
              ...
              >
                ...
                <span className="block text-sm text-gray-400 mt-1">
                  Run Vapi agents inside GHL sub-accounts.
                </span>
              </Link>
              <Link
        ...
        {/* FAQ */}
        <section id="vapi-faq" className="w-full bg-black section-spacing">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">
              ...
              <p className="text-gray-400 text-base sm:text-lg">
                Everything Vapi partners ask before they resell AI voice.
              </p>
            </div>
            <div className="space-y-4">
              {faqs.map((faq) => (
