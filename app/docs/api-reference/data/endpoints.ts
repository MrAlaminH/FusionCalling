...
export const ENDPOINTS: Endpoint[] = [
  ...
  },
  {
    ...
    bodyParams: [
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Caller's phone number in E.164 format (e.g. +15551234567). Create-only — triggers an appointment SMS and cannot be changed via PATCH.",
        example: "+15551234567",
      },
      {
        name: "caller_name",
        ...
        kind: "string",
        required: false,
        description: "Caller's display name (max 200 characters). Create-only — used in the SMS template and cannot be changed via PATCH.",
        example: "Jane Doe",
      },
    ],
    responseStatus: 201,
  ...
  },
  {
    ...
    description: "Update an existing event. Only provided fields are updated. Enable/switch/disable Google Meet or Zoom, or merge new attendees into the list. caller_phone and caller_name are set at create time only and cannot be changed via PATCH.",
    priority: "frequent",
    pathParams: [
      {
        name: "id",
    ...
    bodyParams: [
      ...
      },
      {
        ...
        kind: "array",
        required: false,
        description: "Merged with the stored attendees list (max 50 total). Duplicates are removed by lowercase email; stored display_name/response_status are preserved unless overridden.",
        example: '[{"email":"client@example.com","display_name":"Client Rep"}]',
      },
    ],
    responseStatus: 200,
  ...
  // ─────────────────────────────── Leads ───────────────────────────────
  {
    ...
    bodyParams: [
      ...
      },
      {
        ...
        kind: "string",
        required: true,
        description: "Phone number, 10-25 characters raw, auto-normalized to 10-15 digit E.164.",
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Email address (max 254 characters). Send null to clear.",
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Company name (up to 100 characters). Send null to clear.",
        example: "Acme Corp",
      },
      {
        name: "tags",
        ...
        kind: "array",
        required: false,
        description: "Lead tags (max 20). Each tag must match /^[a-zA-Z0-9_-]+$/ (1-50 chars).",
      ...
      },
      {
        ...
        kind: "object",
        required: false,
        description: "Custom metadata (max 20 keys). Keys match /^[a-zA-Z0-9_-]+$/ (1-50 chars); values can be string (max 1000), number, boolean, or null.",
        example: '{"source":"website","score":8}',
        default: '{"source":"website","score":8}',
      },
      {
        name: "campaign_id",
        type: "UUID",
        kind: "string",
        required: false,
        description: "Target campaign UUID. Omit to route to the Default Feed (call-only).",
        example: "",
      },
      {
        name: "kind",
        ...
        kind: "string",
        required: false,
        description: "Lead kind. Must match the target campaign. 'sms' requires a campaign_id (the Default Feed is call-only).",
        enum: ["call", "sms"],
        example: "call",
      },
    ],
    ...
    "leads": [
      {
        ...
        "custom_fields": { "source": "website", "score": 8 },
        "call_attempts": 0,
  ...
  },
  {
    ...
    bodyParams: [
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Batch-level kind. Must match the target campaign kind. 'sms' requires a campaign_id (the Default Feed is call-only).",
        enum: ["call", "sms"],
        example: "call",
      },
    ],
  ...
  "data": {
    ...
    statusCodes: [
      ...
      { code: 400, description: "Empty batch, batch over 100 leads, or one or more leads failed validation" },
      { code: 401, description: "Invalid or missing API key" },
      { code: 409, description: "Duplicate phone within the target campaign" },
      { code: 429, description: "Rate limit exceeded" },
    ],
    commonErrors: [
      { code: 400, condition: "One or more leads in the batch are invalid", solution: "The response includes a details array with per-index errors: { \"details\": [{ \"index\": 0, \"errors\": [...] }] }. Fix the flagged leads and resend the batch." },
      { code: 409, condition: "Duplicate lead", solution: "Use PATCH to update the existing lead instead." },
    ],
  },
  {
    ...
    queryParams: [
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Optional filter applied after lookup. A matched lead that does not satisfy it returns 404.",
        enum: ["pending", "in-progress", "retry", "completed", "failed"],
        example: "",
      },
      {
        name: "updated_since",
        ...
        kind: "string",
        required: false,
        description: "Optional filter applied after lookup (any parseable datetime -> ISO UTC).",
        example: "",
      },
    ],
    responseStatus: 200,
  ...
  "data": {
    ...
    statusCodes: [
      ...
      { code: 401, description: "Invalid or missing API key" },
      { code: 404, description: "No lead found for that phone, or the matched lead does not satisfy status/updated_since" },
    ],
  },
  {
    id: "leads-list",
    ...
    queryParams: [
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Optional status filter. Omit to return leads of any status.",
        enum: ["pending", "in-progress", "retry", "completed", "failed"],
        example: "pending",
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Only return leads updated since this datetime (any parseable format -> ISO UTC).",
      ...
      },
      {
        ...
        kind: "number",
        required: false,
        description: "Results per page (default 50, min 1, max 100).",
        example: "50",
        default: "50",
      },
      {
        ...
        enum: ["created_at:desc", "created_at:asc", "updated_at:desc"],
  ...
  "data": {
    ...
    "total": 2,
    "leads": [
      { "id": "uuid-1", "name": "John Doe", "phone": "+12345678900", "status": "pending", "tags": ["vip"], "created_at": "2026-06-16T12:00:00.000Z" },
      { "id": "uuid-2", "name": "Jane Roe", "phone": "+12345678901", "status": "pending", "tags": null, "created_at": "2026-06-16T12:05:00.000Z" }
    ]
  }
}`,
    statusCodes: [
      ...
      { code: 401, description: "Invalid or missing API key" },
      { code: 404, description: "No Default Feed exists for the account" },
      { code: 429, description: "Rate limit exceeded" },
    ],
  },
  {
    ...
    bodyParams: [
      {
        ...
        kind: "string",
        required: true,
        description: "Lookup key that identifies the lead (normalized to E.164). The phone number itself cannot be changed.",
        example: "+1234567890",
        default: "+1234567890",
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Optional scoping campaign UUID. Omit to target the Default Feed.",
        example: "",
      },
      {
        name: "kind",
        ...
        kind: "string",
        required: false,
        description: "Updated lead kind. 'sms' requires a campaign_id (the Default Feed is call-only).",
        enum: ["call", "sms"],
        example: "",
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Updated lead name (2-100 characters).",
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Updated email address (max 254). Send null to clear.",
      ...
      },
      {
        ...
        kind: "string",
        required: false,
        description: "Updated company name (max 100). Send null to clear.",
        example: "New Corp",
      },
      {
        name: "tags",
        ...
        kind: "array",
        required: false,
        description: "Updated tags (max 20). Send null to clear.",
        example: "vip,updated",
        default: "vip,updated",
      },
      {
        ...
        kind: "object",
        required: false,
        description: "Merged into the existing custom_fields (keys max 20). Set a key to null to remove it.",
        example: '{"score":9}',
        default: '{"score":9}',
      },
    ],
  ...
  "data": {
    "lead": {
      ...
      "status": "pending",
      "tags": ["vip", "updated"],
      "custom_fields": { "source": "website", "score": 9 },
      "call_attempts": 0,
      "created_at": "2026-06-17T12:00:00.000Z",
