export function OverviewSection() {
  return (
    <section id="what-is-agent" className="mb-16 scroll-mt-36">
      <h2 className="text-3xl font-bold mb-6 text-white">What is an Agent?</h2>

      <p className="text-lg text-gray-300 mb-6">
        An <span className="font-semibold text-white">Agent</span> is an
        ...
        <div className="bg-zinc-900 border border-white/10 rounded-lg p-8">
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-start">
              <span className="text-brand-light mr-3 font-bold">✓</span>
